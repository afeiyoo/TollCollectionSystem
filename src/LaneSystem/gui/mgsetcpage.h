...
class MgsEtcPage : public MgsBasePage
{
    Q_OBJECT
public:
    explicit MgsEtcPage(QWidget *parent = nullptr);
    ~MgsEtcPage() override;
...
private:
    ...
    ElaText *m_normalVehCnt = nullptr;         // 普通车数
    ElaText *m_freeVehCnt = nullptr;           // 免征车数
    ElaText *m_totalToll = nullptr;            // 金额
    ElaText *m_creditCardCnt = nullptr;        // 记账卡数
    ElaText *m_prePayCardCnt = nullptr;        // 储值卡数
